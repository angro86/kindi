...
export const CATEGORIES: CategoriesByAge = {
  2: { songs: '🎵 Songs', movement: '💃 Dance', social: '🤝 Feelings' },
  3: { math: '🔢 Numbers', reading: '📖 Letters', social: '🤝 Social', science: '🔬 Science', movement: '🧘 Yoga' },
  4: { math: '🔢 Math', reading: '📖 Reading', science: '🔬 Science', social: '🤝 Social', stories: '📚 Stories', movement: '🧘 Yoga' },
  5: { math: '🔢 Math', reading: '📖 Reading', science: '🔬 Science', nature: '🌿 Nature', stories: '📚 Stories' },
